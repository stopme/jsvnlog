...
<base href="<%=basePath%>">
<title>jsvnlog</title>
<link rel="stylesheet" type="text/css" href="css/metro/easyui.css" id="swicth-style">
...
.cs-north-bg {
	width: 100%;
	height: 100%;
	background: url(css/gray/images/header_bg.png) repeat-x;
}
.cs-north-logo {
	height: 40px;
...
$(function() {
	...
	var themes = {
		'gray' : 'css/gray/easyui.css',
		'black' : 'css/black/easyui.css',
		'bootstrap' : 'css/bootstrap/easyui.css',
		'default' : 'css/default/easyui.css',
		'metro' : 'css/metro/easyui.css'
	};
...
<body class="easyui-layout">
	<div region="north" border="true" class="cs-north">
		...
		<div class="cs-north-logo">jsvnlog</div>
	...
	<div region="west" border="true" split="true" title="Navigation" class="cs-west">
		<div class="easyui-accordion" fit="true" border="false">
		          <div title="Jsvnlog" selected="true">
		            <p><a href="javascript:void(0);" src="jsp/project.jsp" class="cs-navi-tab">工程管理</a></p>
					<p><a href="javascript:void(0);" src="jsp/repository.jsp" class="cs-navi-tab">SVN仓库</a></p>
					<p><a href="javascript:void(0);" src="jsp/userwork.jsp" class="cs-navi-tab">用户工作量</a></p>
					<p><a href="javascript:void(0);" src="jsp/userZhouQi.jsp" class="cs-navi-tab">用户周期统计</a></p>
	...
	<div id="mainPanle" region="center" border="true" border="false">
		 <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
				...
				<div class="cs-home-remark">
					<h1>jsvnlog 根据svnkit开源实现的log统计软件</h1> <br>
					制作：zero <br>
					博客：<a href="http://blog.csdn.net/kky2010_110" target="_blank">http://blog.csdn.net/kky2010_110</a><br>
					说明：请查看svnkit说明文档.
				</div>
				</div>
        </div>
	...
	<div region="south" border="false" id="south"><center>kky2010@163.com</center></div>
